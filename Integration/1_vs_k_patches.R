...
#---------------------------READ OUTPUT---------------------------#
output_file <- read.csv(file = '~/RMT/Integration/1_vs_k_patch.csv')
output_file$err_eigen <- ((output_file$out1 - output_file$outk)/output_file$outk)^2
output_file$err_inf <- ((output_file$max.inf.1 - output_file$max.inf.k)/output_file$max.inf.k)^2
